...
#ejecuta comando insert a la DB articulos en los campos descripcion y precio,
#  con ? indica la posicion donde se inserta
...
for i in range(20):
    database.execute("insert into articulos(descripcion,precio) values (?,?)",
                     (letrazar(),random.randint(0,500)))
